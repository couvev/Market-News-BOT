...
def cnn(link):
    try:
        ...
        # Encontrando todos os elementos <p> dentro da div com id "article"
        content_elements = driver.find_elements(
            "xpath", "/html/body/div[1]/div[2]/div/main/article/div/p")
...
if __name__ == "__main__":
    text = cnn(
        "https://www.cnnbrasil.com.br/economia/investimentos/tesouro-direto-vendas-de-titulos-publicos-sobem-161-em-marco-e-somam-r-35-bilhoes/")
